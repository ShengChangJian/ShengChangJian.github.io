...
function runCode(){
  ...
  if(!codeValue)
  {
    ...
    if(window.screen.width <= 770){
        codeValue +='<style>li{font-size: 1em;} *{margin: 0; padding: 0;} ol.linenums{ padding-top: 1em; padding-left: 2.5em; padding-down: 1em;width: 100%; height: 100%;}pre{width:100%;height:100%;}</style>';
    }

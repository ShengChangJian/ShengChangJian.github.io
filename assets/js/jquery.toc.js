...
function runCode(){
  ...
  if(!codeValue)
  {
    ...
    codeValue +='<style>pre{width: 780px; height: 400px;overflow: auto;margin:0;padding:0;}code,pre{width: 100%; margin: 0; padding-top: 10px; }body{font-size: 1em;background-color: #2F4F4F;}</style>';
    ...
    if(window.screen.width <= 770){
        codeValue +='<style>pre{width:100%;height:100%;}body{position: absolute;} html{overflow: auto !important; -webkit-overflow-scrolling: touch !important;}li{font-size: 1em;} *{margin: 0; padding: 0;} ol.linenums{ padding-top: 1em; padding-left: 2.2em; width: 100%; height: 100%;}</style>';
    }

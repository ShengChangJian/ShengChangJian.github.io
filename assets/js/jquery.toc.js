...
function runCode(){
  ...
  if(!codeValue)
  {
    ...
    codeValue +='<style>htm,bodyl{margin:0;padding:0;}html{font-size: 1em;background-color: #2F4F4F;position: absolute;width: 780px !important; height: 390px !important; overflow: hidden;-webkit-overflow-scrolling: touch !important;}code,pre{margin: 0; padding-top: 10px; }pre{overflow: auto;width: 780px !important; height: 390px !important;}</style>';
